...
public class RandomScheduling implements SchedulingAlgorithm {

    String id;

    public RandomScheduling() {
        this.id="Random Scheduling Algorithm";
    }
    ...
    public List<ServiceRequest> execute(List<ServiceRequest> lstRequests, List<ServiceProvider> lstProviders){
        ...
        Collections.shuffle(lstRequests);
        Collections.shuffle(lstProviders);
    ...
    public boolean equals(Object o) {
        ...
        RandomScheduling that = (RandomScheduling) o;
