...
public class FirstComeFirstServeTest {
    ...
    private FirstComeFirstServe firstComeFirstServeUnderTest;
    ...
    //sv req:int number, Date date, Client client, PostalAddress postalAddress, List<PreferedSchedule> schedules
    ...
    public void setUp() {
        ...
        sr.setGeoAre(geoAre);
        lstRequests.add(sr);
        firstComeFirstServeUnderTest = new FirstComeFirstServe();
    }
    ...
    public void testCheckBestSchedule() {
        ...
        // Run the test
        final PreferedSchedule result = firstComeFirstServeUnderTest.checkBestSchedule(provider, schedules, duration, requests);
    ...
    public void testCheckOverlap() {
        ...
        // Run the test
        final boolean result = firstComeFirstServeUnderTest.checkOverlap(lstRequest, sched, duration, provider);
    ...
    public void testCheckGeographicalAvailability() {
        ...
        // Run the test
        final boolean result = firstComeFirstServeUnderTest.checkGeographicalAvailability(provider, request);
    ...
    public void testEquals() {
        // Setup
        final Object o = new FirstComeFirstServe();
        final Object nuller=null;
        final Object classer=new RandomScheduling();

        // Run the test
        final boolean result = firstComeFirstServeUnderTest.equals(o);
        final boolean resultNull = firstComeFirstServeUnderTest.equals(nuller);
        final boolean resultClass=firstComeFirstServeUnderTest.equals(classer);
